...
function cetakKwitansiKomisi(id) {
    ...
    if (e.peran === 'Sales') {
        ...
        detailRows = `<tr><td>${e.peran}</td><td>${bundleTotal} bundle terjual</td><td style="text-align:right">${fmtRpFull(rate)}/bundle</td><td style="text-align:right;font-weight:600;color:#3D5A73">${fmtRpFull(totalKomisi)}</td></tr>`;
        ...
        detailRows = `<tr><td>${e.peran}</td><td>${poN.length} PO dinego</td><td style="text-align:right">${fmtRpFull(rate)}/PO</td><td style="text-align:right;font-weight:600;color:#3D5A73">${fmtRpFull(totalKomisi)}</td></tr>`;
        ...
        detailRows = `<tr><td>${e.peran}</td><td>${totalTx} kwitansi tertagih</td><td style="text-align:right">${fmtRpFull(rate)}/kwitansi</td><td style="text-align:right;font-weight:600;color:#3D5A73">${fmtRpFull(totalKomisi)}</td></tr>`;
        ...
        totalKomisi = bundleTotal * rate;
        detailRows = `<tr><td>${e.peran}</td><td>${bundleTotal} bundle lunas</td><td style="text-align:right">${fmtRpFull(rate)}/bundle</td><td style="text-align:right;font-weight:600;color:#3D5A73">${fmtRpFull(totalKomisi)}</td></tr>`;
        ...
        detailRows = trips.map(t => `<tr><td>Supir</td><td>Trip ${t.tanggal || '-'} \u2014 ${t.tujuan || '-'}</td><td style="text-align:right">\u2014</td><td style="text-align:right;font-weight:600;color:#3D5A73">${fmtRpFull(t.upahSupir || 0)}</td></tr>`).join('');
